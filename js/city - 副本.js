var province ={
        ...
        "江苏":["南京","无锡","徐州","常州","苏州","南通","连云港","淮安","盐城","扬州","镇江","泰州","宿迁",
               ...
               "高邮","仪征","丹阳","扬中","句容","靖江","兴化","泰兴","海安","泰兴","沭阳"],
        ...
        "云南":["昆明","曲靖","玉溪","保山","昭通","丽江","普洱","临沧","香格里拉","安宁","德宏","怒江","迪庆","楚雄","红河","文山","西双版纳","大理","宣威","水富","腾冲","个旧","开远","蒙自","弥勒","景洪","瑞丽","芒","泸水"],
        ...
        "河北":["石家庄","唐山","秦皇岛","邯郸","邢台","保定","张家口","承德","沧州","廊坊","衡水",
               "晋州市","新乐市","辛集市","遵化市","迁安市","武安市","南宫市","沙河市","安国市","高碑店市","涿州市","定州市","平泉市",
            "泊头市","黄骅市","河间市","任丘市","霸州市","三河市","深州市"],
    ...
    $('.submit').click(function(){
        ...
        for(var i=0;i<p.length;i++){
            dataArr.push({
                name: p[i],selected:true,value: Math.round(Math.random()*1000)
            })
        }
        console.log(dataArr); 
        // 结果，地图页
